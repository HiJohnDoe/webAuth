...
namespace webAuth
{
    class autoStart
    {
        ...
        /// 快捷方式名称-任意自定义
        /// </summary>
        private const string QuickName = "BDMC网络认证";
        ...
        public void SetMeAutoStart(bool onOff = true)
        {
            if (onOff)//开机启动
            {
                ...
                {
                    CreateShortcut(systemStartPath, QuickName, appAllPath, "BDMC网络认证");
                }
            }
            else//开机不启动
            {
        ...
        public void CreateDesktopQuick(string desktopPath = "", string quickName = "", string appPath = "")
        {
            ...
            {
                CreateShortcut(desktopPath, quickName, appPath, "BDMC网络认证");
            }
        }
    }
}
